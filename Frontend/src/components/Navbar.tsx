...
import { Menu, X, Home, BookOpen, CalendarPlus, ShieldCheck } from "lucide-react"; // Added ShieldCheck
...
export function Navbar() {
  ...
  const baseNavLinks = [
    ...
    { href: "/poojas", label: "Poojas", icon: BookOpen },
    { href: "/booking", label: "Book Now", icon: CalendarPlus },
  ];
